...
public class LuceneConfiguration {
    ...
    public static void main(String[] args) {
        //索引指定的文档路径
        String indexDir = "/Users/xyz/MyProjects/xyz-search/data/indexer";
        ////被索引数据的路径
        String dataDir = "/Users/xyz/Downloads";
        LuceneConfiguration indexer = null;
        int numIndexed = 0;
        //索引开始时间
        long start = System.currentTimeMillis();
        try {
            indexer = new LuceneConfiguration(indexDir);
