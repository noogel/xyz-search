...
public class VectorClient {
    ...
    public void configAppUpdate(ConfigAppUpdateEvent event) {
        try {
            ...
            if ((!Objects.equals(JsonHelper.toJson(newApp.getChat().getQdrant()), JsonHelper.toJson(oldApp.getChat().getQdrant())))
                    || (!Objects.equals(JsonHelper.toJson(newApp.getChat().getOllama()), JsonHelper.toJson(oldApp.getChat().getOllama())))) {
                initClient();
            }
        } catch (Exception e) {
